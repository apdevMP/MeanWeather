...
public class DetailsActivity extends Activity {
	...
	private ImageView ivForecast1, ivForecast2, ivForecast3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivForecast1 = (ImageView) findViewById(R.id.imageView1);
		ivForecast2 = (ImageView) findViewById(R.id.imageView2);
		ivForecast3 = (ImageView) findViewById(R.id.imageView3);
		...
		int code1 = list.get(0).getForecastCode() + ADD_DRAWABLE_ID;
		ivForecast1.setImageResource(code1);
		int code2 = list.get(1).getForecastCode() + ADD_DRAWABLE_ID;
		ivForecast2.setImageResource(code2);
		int code3 = list.get(2).getForecastCode() + ADD_DRAWABLE_ID;
		ivForecast3.setImageResource(code3);	
